"""
@author: Andrew Owens (owens518)
@encoding: UTF_8
@data_cleaning: Split line on non-word characters. Removed punctuation, 
                and tokenized data with nltk.
@language_model: This program uses bigrams and unigrams.
@tweaks: Trigrams are implemented but not used, (less accurate somehow).
         create_ngram_model allows you to create unigrams,bigrams, or trigrams. Uncomment lines 224 and 243 to try trigrams.
@smoothing: add-one smoothing is used (laplace smoothing).
@Results:
        austen_utf8.txt: 30/7385 correct
        dickens_utf8.txt: 29/6727 correct
        tolstoy_utf8.txt: 14/10725 correct
        wilde_utf8.txt: 27/5660 correct

        -test on random textfile

        Classifying Line: 0
        austen_utf8.txt: 0/16 correct
        dickens_utf8.txt: 0/16 correct
        tolstoy_utf8.txt: 0/16 correct
        wilde_utf8.txt: 0/16 correct
        Classifying Line: 1
        austen_utf8.txt: 0/7 correct
        dickens_utf8.txt: 0/7 correct
        tolstoy_utf8.txt: 0/7 correct
        wilde_utf8.txt: 0/7 correct
        Classifying Line: 2
        austen_utf8.txt: 0/8 correct
        dickens_utf8.txt: 0/8 correct
        tolstoy_utf8.txt: 0/8 correct
        wilde_utf8.txt: 0/8 correct
        Classifying Line: 3
        austen_utf8.txt: 0/6 correct
        dickens_utf8.txt: 0/6 correct
        tolstoy_utf8.txt: 0/6 correct
        wilde_utf8.txt: 0/6 correct
